...
**Система анализирует источники**: [rag_answer_2](demo/rag_answer_2.png)  (разговорная форма "опера Биржан-сал" не мешает найти каноничное название оперы - "Биржан и Сара")
